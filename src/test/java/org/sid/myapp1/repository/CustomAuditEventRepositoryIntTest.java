...
import org.sid.myapp1.config.audit.AuditEventConverter;
import org.sid.myapp1.domain.PersistentAuditEvent;
...
import static org.sid.myapp1.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
